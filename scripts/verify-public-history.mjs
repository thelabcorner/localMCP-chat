 ...
 *
 * The current repository's fetched origin/main is the public baseline. The fork may point origin
 * at any owner/repository, so privacy verification deliberately has no predecessor-specific URL.
 */
function publishedCommits() {
  const publishedRef = 'refs/remotes/origin/main';
