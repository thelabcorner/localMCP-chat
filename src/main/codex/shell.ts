...
/**
 * Linux default-shell preference. A configured supported login shell wins.
 ...
 */
export function posixShellPreference(_platform: NodeJS.Platform, configured: ShellType | null): ShellType[] {
